...
class StudentController extends Controller
{
    ...
    public function getTvetStudents(){
    ...
    public function getDegreeScholarship(){
             ...
             for ($i=1; $i <=3 ; $i++) {
                ...
                foreach ($all_semester as $semester) {
                       ...
                       ->where(function ($query) {
                        $query->where('fully_scholarship',1)
                        ->orWhere('partial_scholarship',1);
                    })
    ...
    public function getTvetScholarship(){
